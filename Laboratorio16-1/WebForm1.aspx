...
<body>
    <form id="form1" runat="server">
        ...
        <div class="cal">
            ...
            <asp:Button ID="add" Text="add" runat="server" Height="37px" Style="margin-left: 0px;margin-top:0px;"  
            ...
            <asp:Button ID="sub" Text="sub" runat="server" Height="37px" Style="margin-left: 0px; margin-top: 0px;"
            ...
            <asp:Button ID="clr" Text="CLR" runat="server" Height="37px" Style="margin-left: 0px; margin-top: 0px;"
                Width="57px" OnClick="mul_Click" />
            <asp:Button ID="eql" Text="=" runat="server" Height="37px" Style="margin-left: 0px; margin-top: 0px;"
                Width="57px" OnClick="mul_Click" />
